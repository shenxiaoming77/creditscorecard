...
numerical_data.to_excel(ROOT_DIR + 'numerical_data.xlsx', na_rep='NA', index=None, encoding='utf-8')
categorical_data.to_excel(ROOT_DIR + 'categorical_data.xlsx', na_rep='NA', index = None, encoding='utf-8')


train.to_excel(ROOT_DIR + 'train.xlsx',na_rep= 'NA',index= None, encoding='utf-8')
test.to_excel(ROOT_DIR + 'test.xlsx', na_rep='NA', index= None, encoding='utf-8')